...
public class Openmrs {
	public static void main(String[] args, Object WebDriverManager) throws InterruptedException {
		String[] browsers = { "chrome", "edge", "firefox" };
		for (String browser : browsers) {
			WebDriver driver = null;
			try {
				if (browser.equalsIgnoreCase("chrome")) {
					((io.github.bonigarcia.wdm.WebDriverManager) WebDriverManager).chromedriver().setup();
					driver = new ChromeDriver();
				} else 
					if (browser.equalsIgnoreCase("edge")) {
					((io.github.bonigarcia.wdm.WebDriverManager) WebDriverManager).edgedriver().setup();
					driver = new EdgeDriver();
				} else
					if (browser.equalsIgnoreCase("firefox")) {
					((io.github.bonigarcia.wdm.WebDriverManager) WebDriverManager).firefoxdriver().setup();
